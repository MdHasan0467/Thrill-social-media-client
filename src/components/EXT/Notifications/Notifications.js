...
const Notifications = () => {
	...
	<div className="container px-4 py-16 mx-auto space-y-8 lg:max-w-3xl">
		<div className="space-y-8">
			<div>
				<h3 className="mb-3 text-lg font-bold md:text-xl text-start">2021</h3>
				<ul className="space-y-4">
					<li className="space-y-1 hover:bg-gray-900 hover:text-white cursor-pointer p-2 rounded-lg">
			...
			<div>
				<h3 className="mb-3 text-lg font-bold md:text-xl text-start">2020</h3>
				<ul className="space-y-4">
					<li className="space-y-1 hover:bg-gray-900 hover:text-white cursor-pointer p-2 rounded-lg">
						<div className="flex items-center space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 fill-current dark:text-violet-400">
			...
			<div>
				<h3 className="mb-3 text-lg font-bold md:text-xl text-start">2019</h3>
				<ul className="space-y-4">
					<li className="space-y-1 hover:bg-gray-900 hover:text-white cursor-pointer p-2 rounded-lg">
						<div className="flex items-center space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 fill-current dark:text-violet-400">
